export const DEFAULT_EXPERTS: Expert[] = [
    // AI Router
    {
        id: 'auto-ai', name: 'Auto AI', nameKo: 'Auto AI', icon: '🌐', avatarUrl: '/logos/ancano/icon_dark_128.png', color: 'purple', category: 'ai', description: '최적의 AI를 자동 선택',
        quote: '질문에 맞는 최적의 AI가 답한다',
        sampleQuestions: ['아무 질문이나 해봐', '최적의 AI로 답해줘', '자동으로 골라줘'],
        greeting: '질문에 가장 적합한 AI가 자동으로 답변합니다!',
    },
    {
        id: 'ancano', name: 'ANCANO', nameKo: 'ANCANO', icon: '🔮', avatarUrl: '/logos/ancano/icon_dark_128.png', color: 'purple', category: 'ai', description: 'Ancano 종합 AI 어시스턴트',
        quote: '모든 것을 아우르는 AI',
        sampleQuestions: ['무엇이든 물어보세요', '분석 도와줘', '글 써줘'],
        greeting: 'Ancano입니다. 무엇이든 도와드릴게요!',
    },
    {
        id: 'ancano-pro', name: 'ANCANO Pro', nameKo: 'ANCANO Pro', icon: '💎', avatarUrl: '/logos/ancano/icon_dark_128.png', color: 'purple', category: 'ai', description: 'Ancano 프리미엄 AI 어시스턴트',
        quote: '최고 수준의 AI 경험',
        sampleQuestions: ['심층 분석 해줘', '복잡한 문제 풀어줘', '전문가 수준으로 답해줘'],
        greeting: 'Ancano Pro입니다. 최고 수준의 답변을 드릴게요!',
    },
    {
        id: 'auto-gpt', name: 'GPT', nameKo: 'GPT', icon: '🤖', avatarUrl: '/logos/gpt.svg', color: 'blue', category: 'ai', description: '질문에 맞는 최적의 GPT 버전을 자동 선택하여 응답합니다',
        quote: 'AI의 선구자, OpenAI',
        sampleQuestions: ['무엇이든 물어보세요', '분석 도와줘', '글 써줘'],
        greeting: 'OpenAI GPT입니다. 무엇이든 물어보세요!',
    },
    {
        id: 'auto-claude', name: 'Claude', nameKo: 'Claude', icon: '🧡', avatarUrl: '/logos/claude.png', color: 'orange', category: 'ai', description: '질문에 맞는 최적의 Claude 버전을 자동 선택하여 응답합니다',
        quote: '안전하고 유능한 AI',
        sampleQuestions: ['코드 리뷰해줘', '분석 부탁해', '글 다듬어줘'],
        greeting: 'Anthropic Claude입니다!',
    },
    {
        id: 'auto-gemini', name: 'Gemini', nameKo: 'Gemini', icon: '💎', avatarUrl: '/logos/gemini.svg', color: 'emerald', category: 'ai', description: '질문에 맞는 최적의 Gemini 버전을 자동 선택하여 응답합니다',
        quote: '구글이 만든 차세대 AI',
        sampleQuestions: ['검색 도와줘', '분석해줘', '요약해줘'],
        greeting: 'Google Gemini입니다!',
    },
    {
        id: 'auto-grok', name: 'Grok', nameKo: 'Grok', icon: '⚡', avatarUrl: '/logos/grok.svg', color: 'teal', category: 'ai', description: '질문에 맞는 최적의 Grok 버전을 자동 선택하여 응답합니다',
        quote: '거침없는 AI, Grok',
        sampleQuestions: ['솔직하게 답해줘', '트렌드 알려줘', '분석해줘'],
        greeting: 'xAI Grok입니다!',
    },
    {
        id: 'auto-perplexity', name: 'Perplexity', nameKo: 'Perplexity', icon: '🔍', avatarUrl: '/logos/perplexity.svg', color: 'pink', category: 'ai', description: '질문에 맞는 최적의 Perplexity 모델을 자동 선택하여 응답합니다',
        quote: '출처와 함께 답한다',
        sampleQuestions: ['최신 뉴스 알려줘', '검색해줘', '출처 포함 답변해줘'],
        greeting: 'Perplexity입니다!',
    },
    {
        id: 'auto-qwen', name: 'Qwen', nameKo: 'Qwen', icon: '🌏', avatarUrl: '/logos/qwen.png', color: 'amber', category: 'ai', description: '질문에 맞는 최적의 Qwen 버전을 자동 선택하여 응답합니다',
        quote: '알리바바가 만든 AI',
    ...
    // AI 챗봇
    {
        id: 'gpt', name: 'GPT-5.4', nameKo: 'GPT-5.4', icon: '🤖', avatarUrl: '/logos/gpt.svg', color: 'blue', category: 'ai', description: 'AI 최상위 추론 모델',
        quote: '깊이 있는 사고가 답이다',
        sampleQuestions: ['복잡한 논리 문제 풀어줘', '다단계 분석 해줘', '코드 아키텍처 설계해줘'],
        greeting: '안녕하세요! 가장 깊이 있는 분석과 추론을 제공합니다.',
        abilities: { coding: 95, creativity: 90, reasoning: 96, math: 94, multilingual: 88, speed: 70, costEfficiency: 45, contextWindow: 85 },
    },
    {
        id: 'gpt-mini', name: 'GPT-5.4 Mini', nameKo: 'GPT-5.4 Mini', icon: '⚡', avatarUrl: '/logos/gpt.svg', color: 'blue', category: 'ai', description: 'AI 고속 범용 모델',
        quote: '빠르고 정확하게',
        sampleQuestions: ['요약 빠르게 해줘', '간단한 질문 답해줘', '번역 부탁해'],
        greeting: '빠르고 정확한 답변을 드릴게요!',
        abilities: { coding: 82, creativity: 78, reasoning: 85, math: 80, multilingual: 82, speed: 92, costEfficiency: 85, contextWindow: 75 },
    },
    {
        id: 'gpt-nano', name: 'GPT-5.4 Nano', nameKo: 'GPT-5.4 Nano', icon: '💨', avatarUrl: '/logos/gpt.svg', color: 'blue', category: 'ai', description: 'AI 초경량 즉답 모델',
        quote: '가볍지만 똑똑하게',
        sampleQuestions: ['한 줄로 답해줘', '단어 뜻 알려줘', '맞춤법 확인해줘'],
        greeting: '초고속으로 답변드려요!',
        abilities: { coding: 65, creativity: 60, reasoning: 68, math: 62, multilingual: 70, speed: 98, costEfficiency: 95, contextWindow: 55 },
    },
    {
        id: 'claude', name: 'Claude Opus 4.6', nameKo: 'Claude Opus 4.6', icon: '🧡', avatarUrl: '/logos/claude.svg', color: 'orange', category: 'ai', description: 'AI 최고 지능 모델',
        quote: '깊이와 정확성의 끝판왕',
        sampleQuestions: ['복잡한 코드 리뷰 해줘', '논문 수준 분석 부탁해', '다국어 번역 비교해줘'],
        greeting: '안녕하세요. 가장 깊이 있는 분석을 제공합니다.',
        abilities: { coding: 97, creativity: 92, reasoning: 97, math: 90, multilingual: 90, speed: 60, costEfficiency: 35, contextWindow: 90 },
    },
    {
        id: 'claude-sonnet', name: 'Claude Sonnet 4.5', nameKo: 'Claude Sonnet 4.5', icon: '🎵', avatarUrl: '/logos/claude.svg', color: 'orange', category: 'ai', description: 'AI 균형 잡힌 만능 모델',
        quote: '속도와 품질의 황금 비율',
        sampleQuestions: ['글쓰기 도와줘', '코딩 질문 있어', '아이디어 정리해줘'],
        greeting: '빠르면서도 정확한 답변을 드릴게요.',
        abilities: { coding: 92, creativity: 88, reasoning: 90, math: 85, multilingual: 87, speed: 82, costEfficiency: 70, contextWindow: 90 },
    },
    {
        id: 'claude-sonnet-4.6', name: 'Claude Sonnet 4.6', nameKo: 'Claude Sonnet 4.6', icon: '🎶', avatarUrl: '/logos/claude.svg', color: 'orange', category: 'ai', description: 'AI 최신 균형 모델',
        quote: '더 빠르고 더 정확하게',
        sampleQuestions: ['복잡한 분석 해줘', '글 다듬어줘', '코드 최적화해줘'],
        greeting: '최신 Sonnet입니다. 무엇이든 물어보세요.',
        abilities: { coding: 94, creativity: 90, reasoning: 92, math: 88, multilingual: 89, speed: 80, costEfficiency: 65, contextWindow: 90 },
    },
    {
        id: 'claude-haiku', name: 'Claude Haiku 4.5', nameKo: 'Claude Haiku 4.5', icon: '🍃', avatarUrl: '/logos/claude.svg', color: 'orange', category: 'ai', description: 'AI 초고속 경량 모델',
        quote: '순간의 답, 핵심만',
        sampleQuestions: ['한 줄 요약해줘', '빠르게 답변해줘', '간단한 질문이야'],
        greeting: '빠르게 핵심만 답해드려요!',
        abilities: { coding: 78, creativity: 72, reasoning: 75, math: 70, multilingual: 80, speed: 95, costEfficiency: 92, contextWindow: 90 },
    },
    {
        id: 'gemini', name: 'Gemini 2.5 Flash', nameKo: 'Gemini 2.5 Flash', icon: '💎', avatarUrl: '/logos/gemini.svg', color: 'emerald', category: 'ai', description: 'AI 고속 만능 모델',
        quote: '빠르고 똑똑하게',
        sampleQuestions: ['복잡한 질문 빠르게 답해줘', '코드 리뷰 해줘', '문서 요약해줘'],
        greeting: '안녕하세요! 빠르고 정확한 답변을 드릴게요.',
        abilities: { coding: 88, creativity: 82, reasoning: 88, math: 86, multilingual: 85, speed: 90, costEfficiency: 88, contextWindow: 95 },
    },
    {
        id: 'gemini-3-flash', name: 'Gemini 3 Flash', nameKo: 'Gemini 3 Flash', icon: '⚡', avatarUrl: '/logos/gemini.svg', color: 'emerald', category: 'ai', description: 'AI 차세대 고속 모델',
        quote: '속도와 지능의 다음 세대',
        sampleQuestions: ['최신 Gemini 3 성능 어때?', '멀티모달 분석 해줘', '긴 문서 처리 가능해?'],
        greeting: '차세대 Gemini입니다. 무엇이든 물어보세요!',
        abilities: { coding: 90, creativity: 85, reasoning: 90, math: 88, multilingual: 87, speed: 92, costEfficiency: 85, contextWindow: 95 },
    },
    {
        id: 'gemini-3.1', name: 'Gemini 3.1 Lite', nameKo: 'Gemini 3.1 Lite', icon: '🍃', avatarUrl: '/logos/gemini.svg', color: 'emerald', category: 'ai', description: 'AI 초경량 최신 모델',
        quote: '가볍지만 최신 기술',
        sampleQuestions: ['간단한 질문 빠르게', '한 줄 요약해줘', '번역 부탁해'],
        greeting: '가볍고 빠르게 답해드려요!',
        abilities: { coding: 72, creativity: 68, reasoning: 74, math: 70, multilingual: 78, speed: 96, costEfficiency: 95, contextWindow: 80 },
    },
    {
        id: 'gemini-pro', name: 'Gemini 3.1 Pro', nameKo: 'Gemini 3.1 Pro', icon: '👑', avatarUrl: '/logos/gemini.svg', color: 'emerald', category: 'ai', description: 'AI 최상위 프로 모델',
        quote: '프로급 분석과 추론',
    ...
    },
    {
        ...
        abilities: { coding: 70, creativity: 72, reasoning: 78, math: 68, multilingual: 80, speed: 85, costEfficiency: 65, contextWindow: 75 },
    },
    {
        id: 'perplexity-pro', name: 'Perplexity Sonar Pro', nameKo: 'Perplexity Sonar Pro', icon: '🔎', avatarUrl: '/logos/perplexity.svg', color: 'pink', category: 'ai', description: 'AI 심층 리서치 모델',
        quote: '깊이 있는 검색, 정확한 출처',
        sampleQuestions: ['심층 리서치 해줘', '논문 기반으로 분석해줘', '팩트체크 부탁해'],
        greeting: '깊이 있는 리서치를 제공합니다.',
        abilities: { coding: 75, creativity: 76, reasoning: 82, math: 72, multilingual: 82, speed: 78, costEfficiency: 55, contextWindow: 80 },
    },
    {
        id: 'grok', name: 'Grok 4.1 Fast', nameKo: 'Grok 4.1 Fast', icon: '⚡', avatarUrl: '/logos/grok.svg', color: 'teal', category: 'ai', description: 'AI 고속 위트 모델',
        quote: '빠르고 거침없이',
        sampleQuestions: ['그록은 왜 거침없이 말해?', 'X 실시간 데이터 분석 돼?', '일론 머스크 어떻게 봐?'],
        greeting: '뭐든 솔직하게 답해줄게. 뭐가 궁금해?',
        abilities: { coding: 85, creativity: 80, reasoning: 86, math: 82, multilingual: 75, speed: 88, costEfficiency: 72, contextWindow: 80 },
    },
    {
        id: 'grok-4.2', name: 'Grok 4.2', nameKo: 'Grok 4.2', icon: '🔥', avatarUrl: '/logos/grok.svg', color: 'teal', category: 'ai', description: 'AI 최신 추론 모델',
        quote: '유머 없는 AI는 심심하다',
        sampleQuestions: ['최신 그록 성능 어때?', '심층 분석 해줘', '솔직한 의견 줘'],
        greeting: '최신 Grok입니다. 뭐든 물어보세요!',
        abilities: { coding: 88, creativity: 84, reasoning: 90, math: 86, multilingual: 78, speed: 82, costEfficiency: 60, contextWindow: 85 },
    },
    {
        id: 'deepseek', name: 'DeepSeek V3', nameKo: 'DeepSeek V3', icon: '🌊', avatarUrl: '/logos/deepseek.svg', color: 'purple', category: 'ai', description: 'AI 심층분석 전문가',
        quote: '추론은 깊이가 생명이다',
        sampleQuestions: ['R1 추론 모델 뭐가 달라?', '딥시크 코딩 실력 어때?', '딥시크가 수학 잘하는 이유?'],
        abilities: { coding: 90, creativity: 78, reasoning: 88, math: 92, multilingual: 82, speed: 80, costEfficiency: 92, contextWindow: 80 },
    },
    {
        id: 'deepseek-r1', name: 'DeepSeek R1', nameKo: 'DeepSeek R1', icon: '🧠', avatarUrl: '/logos/deepseek.svg', color: 'purple', category: 'ai', description: 'DeepSeek 추론 특화 모델',
        quote: '생각의 과정을 보여준다',
        sampleQuestions: ['단계별로 추론해줘', '수학 문제 풀어줘', '논리적 허점 찾아줘'],
        greeting: 'DeepSeek R1입니다. 깊이 있는 추론을 제공합니다!',
        abilities: { coding: 88, creativity: 72, reasoning: 94, math: 96, multilingual: 78, speed: 65, costEfficiency: 90, contextWindow: 80 },
    },
    {
        id: 'qwen', name: 'Qwen 3.5 Flash', nameKo: 'Qwen 3.5 Flash', icon: '🌏', avatarUrl: '/logos/qwen.svg', color: 'amber', category: 'ai', description: 'AI 고속 다국어 모델',
    ...
    },
    {
        ...
        abilities: { coding: 86, creativity: 80, reasoning: 86, math: 88, multilingual: 96, speed: 82, costEfficiency: 82, contextWindow: 82 },
    },
    {
        id: 'qwen-thinking', name: 'Qwen3 Max Thinking', nameKo: 'Qwen3 Max Thinking', icon: '🧩', avatarUrl: '/logos/qwen.svg', color: 'amber', category: 'ai', description: 'Qwen 추론 특화 모델',
        quote: '생각하는 과정이 답이다',
        sampleQuestions: ['단계별 추론 해줘', '복잡한 논리 문제 풀어줘', '추론 과정 보여줘'],
        greeting: 'Qwen3 Max Thinking입니다!',
        abilities: { coding: 88, creativity: 76, reasoning: 92, math: 94, multilingual: 92, speed: 62, costEfficiency: 70, contextWindow: 80 },
    },
    {
        id: 'llama-maverick', name: 'Llama 4 Maverick', nameKo: 'Llama 4 Maverick', icon: '🦙', color: 'blue', category: 'ai', description: 'Meta 최강 오픈소스 모델',
        quote: '오픈소스의 끝판왕',
        sampleQuestions: ['복잡한 추론 문제 풀어줘', '긴 문서 분석해줘', '코드 리뷰 해줘'],
        greeting: 'Meta의 최강 오픈소스 모델입니다!',
        abilities: { coding: 88, creativity: 82, reasoning: 88, math: 86, multilingual: 84, speed: 75, costEfficiency: 88, contextWindow: 90 },
    },
    {
        id: 'llama-scout', name: 'Llama 4 Scout', nameKo: 'Llama 4 Scout', icon: '🦙', color: 'blue', category: 'ai', description: 'Meta 경량 고속 모델',
        quote: '가볍지만 똑똑하게',
        sampleQuestions: ['빠르게 요약해줘', '간단한 질문 답해줘', '번역 부탁해'],
        greeting: '빠르고 가벼운 Llama입니다!',
        abilities: { coding: 78, creativity: 72, reasoning: 76, math: 74, multilingual: 78, speed: 90, costEfficiency: 92, contextWindow: 82 },
    },
    {
        id: 'mistral-large', name: 'Mistral Large 3', nameKo: 'Mistral Large 3', icon: '🌬️', color: 'slate', category: 'ai', description: '유럽 최상위 AI 모델',
        quote: '유럽의 자존심',
        sampleQuestions: ['다국어 분석 해줘', '심층 추론 부탁해', '논리적으로 정리해줘'],
        greeting: '유럽 최고의 AI, Mistral입니다.',
        abilities: { coding: 85, creativity: 82, reasoning: 86, math: 82, multilingual: 92, speed: 75, costEfficiency: 68, contextWindow: 75 },
    },
    {
        id: 'mistral-medium', name: 'Mistral Medium 3.1', nameKo: 'Mistral Medium 3.1', icon: '🌀', color: 'slate', category: 'ai', description: '유럽 균형잡힌 AI 모델',
        quote: '품질과 속도의 균형',
        sampleQuestions: ['글 다듬어줘', '요약 정리해줘', '비교 분석해줘'],
        greeting: '균형 잡힌 Mistral Medium입니다.',
        abilities: { coding: 80, creativity: 78, reasoning: 82, math: 78, multilingual: 88, speed: 82, costEfficiency: 75, contextWindow: 72 },
    },
    {
        id: 'mistral-small', name: 'Mistral Small 4', nameKo: 'Mistral Small 4', icon: '💨', color: 'slate', category: 'ai', description: '유럽 경량 고속 모델',
        quote: '작지만 빠르게',
        sampleQuestions: ['간단한 질문 답해줘', '한 줄 요약해줘', '빠르게 번역해줘'],
        greeting: '가볍고 빠른 Mistral Small입니다!',
        abilities: { coding: 72, creativity: 70, reasoning: 74, math: 70, multilingual: 82, speed: 92, costEfficiency: 90, contextWindow: 65 },
    },
    {
        id: 'codestral', name: 'Codestral', nameKo: 'Codestral', icon: '💻', color: 'slate', category: 'ai', description: 'Mistral 코딩 전용 모델',
        quote: '코드는 내 언어다',
        sampleQuestions: ['코드 리뷰 해줘', '버그 찾아줘', '리팩토링 도와줘'],
        greeting: 'Mistral Codestral입니다. 코딩을 도와드릴게요!',
        abilities: { coding: 92, creativity: 65, reasoning: 80, math: 78, multilingual: 70, speed: 85, costEfficiency: 82, contextWindow: 70 },
    },
    {
        id: 'mistral-creative', name: 'Mistral Small Creative', nameKo: 'Mistral Small Creative', icon: '🎨', color: 'slate', category: 'ai', description: '창작 글쓰기 특화 모델',
        quote: '창의력은 AI에게도 있다',
        sampleQuestions: ['소설 초안 써줘', '창의적 글 써줘', '시 한 편 지어줘'],
        greeting: '창작 전문 Mistral입니다!',
        abilities: { coding: 55, creativity: 94, reasoning: 68, math: 50, multilingual: 80, speed: 88, costEfficiency: 88, contextWindow: 60 },
    },
    {
        id: 'devstral', name: 'Devstral Medium', nameKo: 'Devstral Medium', icon: '🛠️', color: 'slate', category: 'ai', description: 'Mistral 개발자 특화 모델',
        quote: '개발자를 위한 AI',
        sampleQuestions: ['아키텍처 설계 도와줘', '코드 구조 분석해줘', 'API 설계해줘'],
        greeting: 'Devstral입니다. 개발을 도와드릴게요!',
        abilities: { coding: 90, creativity: 68, reasoning: 82, math: 78, multilingual: 75, speed: 80, costEfficiency: 80, contextWindow: 72 },
    },
    {
        id: 'gemma', name: 'Gemma 4 31B', nameKo: 'Gemma 4 31B', icon: '💠', avatarUrl: '/logos/gemini.svg', color: 'emerald', category: 'ai', description: '구글 오픈소스 최신 모델',
        quote: '오픈소스 Gemini의 힘',
        sampleQuestions: ['가볍게 분석해줘', '코드 설명해줘', '개념 정리해줘'],
        greeting: '구글 오픈소스 Gemma입니다!',
        abilities: { coding: 80, creativity: 75, reasoning: 80, math: 78, multilingual: 82, speed: 82, costEfficiency: 90, contextWindow: 75 },
    },
    {
        id: 'phi', name: 'Phi-4', nameKo: 'Phi-4', icon: '🔬', color: 'blue', category: 'ai', description: 'MS 소형 추론 특화 모델',
        quote: '작은 몸에 큰 두뇌',
        sampleQuestions: ['논리 문제 풀어줘', '수학 추론 해줘', '코드 디버깅 도와줘'],
        greeting: '작지만 강력한 Phi입니다!',
        abilities: { coding: 78, creativity: 65, reasoning: 82, math: 85, multilingual: 70, speed: 88, costEfficiency: 95, contextWindow: 55 },
    },
    {
        id: 'command-r-plus', name: 'Command R+', nameKo: 'Command R+', icon: '📚', color: 'green', category: 'ai', description: '검색·출처 특화 AI 모델',
        quote: '근거 없으면 말 안 한다',
        sampleQuestions: ['출처 포함해서 답해줘', '근거 자료 찾아줘', '팩트체크 해줘'],
        greeting: '출처 기반 답변을 제공합니다.',
        abilities: { coding: 72, creativity: 70, reasoning: 78, math: 68, multilingual: 82, speed: 78, costEfficiency: 72, contextWindow: 82 },
    },
    {
        id: 'command-a', name: 'Command A', nameKo: 'Command A', icon: '📗', color: 'green', category: 'ai', description: 'Cohere 최신 AI 모델',
        quote: '최신 Cohere의 힘',
        sampleQuestions: ['복잡한 분석 해줘', '문서 요약해줘', '출처 기반 답변해줘'],
        greeting: 'Cohere Command A입니다!',
        abilities: { coding: 78, creativity: 74, reasoning: 82, math: 74, multilingual: 84, speed: 80, costEfficiency: 70, contextWindow: 85 },
    },
    {
        id: 'nova-premier', name: 'Amazon Nova Premier', nameKo: 'Amazon Nova Premier', icon: '📦', color: 'amber', category: 'ai', description: '아마존 최상위 AI 모델',
        quote: '클라우드 거인의 두뇌',
        sampleQuestions: ['복잡한 분석 해줘', '긴 문서 처리해줘', '멀티모달 분석해줘'],
        greeting: '아마존 최상위 모델입니다.',
        abilities: { coding: 84, creativity: 80, reasoning: 86, math: 82, multilingual: 82, speed: 72, costEfficiency: 55, contextWindow: 88 },
    },
    {
        id: 'nova-2-lite', name: 'Amazon Nova 2 Lite', nameKo: 'Amazon Nova 2 Lite', icon: '📦', color: 'amber', category: 'ai', description: '아마존 최신 경량 모델, 컨텍스트 1M',
        quote: '가볍지만 클라우드 파워',
        sampleQuestions: ['빠르게 요약해줘', '간단한 질문 답해줘', '긴 문서 처리해줘'],
        greeting: 'Amazon Nova 2 Lite입니다!',
        abilities: { coding: 72, creativity: 68, reasoning: 74, math: 70, multilingual: 76, speed: 90, costEfficiency: 88, contextWindow: 95 },
    },
    {
        id: 'dolphin', name: 'Dolphin (Venice)', nameKo: 'Dolphin (Venice)', icon: '🐬', color: 'cyan', category: 'ai', description: '검열 없는 자유로운 AI',
        quote: '솔직함이 최고의 답이다',
        sampleQuestions: ['거침없이 의견 줘', '솔직하게 평가해줘', '금기 없이 토론하자'],
        greeting: '검열 없이 솔직하게 답해드려요!',
        abilities: { coding: 75, creativity: 82, reasoning: 76, math: 70, multilingual: 74, speed: 82, costEfficiency: 85, contextWindow: 70 },
    },
    {
        id: 'glm', name: 'GLM 5.1', nameKo: 'GLM 5.1', icon: '🔷', avatarUrl: '/logos/glm.svg', color: 'blue', category: 'ai', description: '중국 최신 대형 AI 모델',
        quote: '중국 AI의 새로운 기준',
        sampleQuestions: ['복잡한 분석 해줘', '중국어 번역 비교해줘', '논리적으로 정리해줘'],
        greeting: 'GLM 5.1입니다. 무엇이든 물어보세요!',
        abilities: { coding: 84, creativity: 78, reasoning: 86, math: 84, multilingual: 90, speed: 78, costEfficiency: 80, contextWindow: 82 },
    },
    {
        id: 'glm-5v', name: 'GLM 5V Turbo', nameKo: 'GLM 5V Turbo', icon: '👁️', avatarUrl: '/logos/glm.svg', color: 'blue', category: 'ai', description: 'Z.ai 비전+텍스트 모델',
        quote: '보고 읽고 이해한다',
        sampleQuestions: ['이미지 분석해줘', '사진 설명해줘', '비전 분석 해줘'],
        greeting: 'GLM 5V Turbo입니다. 이미지도 이해해요!',
        abilities: { coding: 76, creativity: 74, reasoning: 80, math: 76, multilingual: 85, speed: 88, costEfficiency: 85, contextWindow: 75 },
    },
    {
        id: 'mimo', name: 'MiMo-V2-Pro', nameKo: 'MiMo-V2-Pro', icon: '📱', avatarUrl: '/logos/xiaomi.svg', color: 'orange', category: 'ai', description: '샤오미 AI 프로 모델',
        quote: '기술은 모두를 위한 것',
        sampleQuestions: ['멀티모달 분석 해줘', '이미지 설명해줘', '문서 정리해줘'],
        greeting: '샤오미 MiMo입니다. 무엇이든 도와드릴게요!',
        abilities: { coding: 82, creativity: 76, reasoning: 84, math: 82, multilingual: 80, speed: 78, costEfficiency: 75, contextWindow: 78 },
    },
    {
        id: 'mimo-flash', name: 'MiMo-V2-Flash', nameKo: 'MiMo-V2-Flash', icon: '⚡', avatarUrl: '/logos/xiaomi.svg', color: 'orange', category: 'ai', description: '샤오미 AI 경량 고속 모델',
        quote: '빠른 샤오미의 힘',
        sampleQuestions: ['빠르게 답해줘', '간단히 요약해줘', '핵심만 알려줘'],
        greeting: '초고속 MiMo Flash입니다!',
        abilities: { coding: 72, creativity: 68, reasoning: 74, math: 72, multilingual: 74, speed: 94, costEfficiency: 90, contextWindow: 70 },
    },
    {
        id: 'nemotron', name: 'Nemotron 3 Super', nameKo: 'Nemotron 3 Super', icon: '🟢', avatarUrl: '/logos/nvidia.svg', color: 'green', category: 'ai', description: 'NVIDIA 120B 초대형 모델',
        quote: 'GPU의 아버지가 만든 AI',
        sampleQuestions: ['복잡한 추론 풀어줘', '코드 최적화해줘', '기술 분석해줘'],
        greeting: 'NVIDIA Nemotron입니다!',
        abilities: { coding: 88, creativity: 78, reasoning: 88, math: 86, multilingual: 80, speed: 70, costEfficiency: 72, contextWindow: 82 },
    },
    {
        id: 'seed', name: 'Seed 2.0 Lite', nameKo: 'Seed 2.0 Lite', icon: '🎵', avatarUrl: '/logos/bytedance.svg', color: 'blue', category: 'ai', description: '바이트댄스 최신 AI 모델',
        quote: '틱톡을 만든 회사의 AI',
        sampleQuestions: ['창의적 글 써줘', '트렌드 분석해줘', '콘텐츠 아이디어 줘'],
        greeting: '바이트댄스 Seed입니다!',
        abilities: { coding: 80, creativity: 82, reasoning: 80, math: 78, multilingual: 84, speed: 85, costEfficiency: 82, contextWindow: 78 },
    },
    {
        id: 'seed-mini', name: 'Seed 2.0 Mini', nameKo: 'Seed 2.0 Mini', icon: '🎶', avatarUrl: '/logos/bytedance.svg', color: 'blue', category: 'ai', description: '바이트댄스 경량 AI 모델',
        quote: '작지만 틱톡 파워',
        sampleQuestions: ['간단히 답해줘', '빠르게 정리해줘', '짧게 요약해줘'],
        greeting: 'Seed 2.0 Mini입니다!',
        abilities: { coding: 70, creativity: 72, reasoning: 72, math: 68, multilingual: 78, speed: 92, costEfficiency: 92, contextWindow: 68 },
    },
    {
        id: 'minimax', name: 'MiniMax M2.7', nameKo: 'MiniMax M2.7', icon: '🟣', avatarUrl: '/logos/minimax.svg', color: 'purple', category: 'ai', description: '중국 멀티모달 최신 모델',
        quote: '작은 이름, 큰 성능',
        sampleQuestions: ['멀티모달 분석해줘', '긴 문서 처리해줘', '복잡한 질문 답해줘'],
        greeting: 'MiniMax M2.7입니다!',
        abilities: { coding: 80, creativity: 78, reasoning: 82, math: 80, multilingual: 84, speed: 80, costEfficiency: 78, contextWindow: 90 },
    },
    {
        id: 'kimi', name: 'Kimi K2.5', nameKo: 'Kimi K2.5', icon: '🌙', avatarUrl: '/logos/moonshot.svg', color: 'slate', category: 'ai', description: '장문맥 특화 AI 모델',
        quote: '긴 글도 한눈에',
        sampleQuestions: ['긴 문서 분석해줘', '논문 요약해줘', '전체 맥락 정리해줘'],
        greeting: 'Moonshot Kimi입니다. 긴 문서도 거뜬해요!',
        abilities: { coding: 80, creativity: 76, reasoning: 82, math: 78, multilingual: 82, speed: 78, costEfficiency: 75, contextWindow: 96 },
    },
    {
        id: 'kimi-thinking', name: 'Kimi K2 Thinking', nameKo: 'Kimi K2 Thinking', icon: '🌑', avatarUrl: '/logos/moonshot.svg', color: 'slate', category: 'ai', description: 'Moonshot 추론 특화 모델',
        quote: '달빛 아래 깊은 사고',
        sampleQuestions: ['단계별 추론 해줘', '복잡한 문제 분석해줘', '논리적으로 풀어줘'],
        greeting: 'Kimi Thinking입니다. 깊이 생각해드릴게요!',
        abilities: { coding: 82, creativity: 74, reasoning: 90, math: 88, multilingual: 80, speed: 65, costEfficiency: 70, contextWindow: 92 },
    },
    {
        id: 'solar', name: 'Solar Pro 3', nameKo: 'Solar Pro 3', icon: '☀️', avatarUrl: '/logos/solar.svg', color: 'orange', category: 'ai', description: '한국 업스테이지 AI 모델',
        quote: '한국이 만든 세계적 AI',
        sampleQuestions: ['한국어 분석해줘', '문서 이해해줘', '자연스럽게 번역해줘'],
        greeting: '한국의 업스테이지 Solar입니다!',
        abilities: { coding: 76, creativity: 74, reasoning: 78, math: 74, multilingual: 88, speed: 80, costEfficiency: 82, contextWindow: 72 },
    },
    {
        id: 'mercury', name: 'Mercury 2', nameKo: 'Mercury 2', icon: '💫', avatarUrl: '/logos/mercury.svg', color: 'cyan', category: 'ai', description: 'UAE 초고속 추론 모델',
        quote: '빛의 속도로 생각한다',
        sampleQuestions: ['빠르게 분석해줘', '즉시 답변해줘', '추론 문제 풀어줘'],
        greeting: '초고속 Mercury입니다!',
        abilities: { coding: 80, creativity: 72, reasoning: 82, math: 80, multilingual: 75, speed: 96, costEfficiency: 78, contextWindow: 72 },
    },
    {
        id: 'ernie', name: 'ERNIE 4.5', nameKo: 'ERNIE 4.5', icon: '🐾', avatarUrl: '/logos/baidu.svg', color: 'blue', category: 'ai', description: '바이두 300B 초대형 모델',
        quote: '중국 검색 1위의 AI',
        sampleQuestions: ['복잡한 분석 해줘', '중국 시장 트렌드 알려줘', '다국어 비교해줘'],
        greeting: '바이두 ERNIE입니다!',
        abilities: { coding: 82, creativity: 78, reasoning: 84, math: 82, multilingual: 88, speed: 72, costEfficiency: 70, contextWindow: 85 },
    },
    {
        id: 'hunyuan', name: 'Hunyuan', nameKo: 'Hunyuan', icon: '💬', avatarUrl: '/logos/tencent.svg', color: 'blue', category: 'ai', description: '텐센트 AI 모델',
        quote: '위챗을 만든 회사의 AI',
        sampleQuestions: ['대화형 분석 해줘', '소셜 트렌드 분석해줘', '중국어 자연스럽게 번역해줘'],
        greeting: '텐센트 Hunyuan입니다!',
        abilities: { coding: 78, creativity: 76, reasoning: 80, math: 78, multilingual: 86, speed: 76, costEfficiency: 75, contextWindow: 80 },
    },
    {
        id: 'jamba', name: 'Jamba Large 1.7', nameKo: 'Jamba Large 1.7', icon: '🔮', avatarUrl: '/logos/ai21.svg', color: 'purple', category: 'ai', description: '이스라엘 AI21 대형 모델',
        quote: '혁신은 이스라엘에서',
        sampleQuestions: ['긴 문서 분석해줘', '요약 정리해줘', '복잡한 추론 해줘'],
        greeting: 'AI21 Jamba입니다!',
        abilities: { coding: 78, creativity: 74, reasoning: 80, math: 76, multilingual: 78, speed: 75, costEfficiency: 72, contextWindow: 92 },
    },
    {
        id: 'granite', name: 'Granite 4.0', nameKo: 'Granite 4.0', icon: '🏢', avatarUrl: '/logos/ibm.svg', color: 'blue', category: 'ai', description: 'IBM 엔터프라이즈 AI 모델',
        quote: '기업용 AI의 정석',
        sampleQuestions: ['비즈니스 분석 해줘', '보고서 작성 도와줘', '데이터 정리해줘'],
        greeting: 'IBM Granite입니다!',
        abilities: { coding: 80, creativity: 70, reasoning: 82, math: 78, multilingual: 80, speed: 76, costEfficiency: 78, contextWindow: 78 },
    },
    {
        id: 'step', name: 'Step 3.5 Flash', nameKo: 'Step 3.5 Flash', icon: '🚀', avatarUrl: '/logos/stepfun.svg', color: 'orange', category: 'ai', description: '스텝펀 최신 고속 모델',
        quote: '한 걸음씩, 하지만 빠르게',
        sampleQuestions: ['빠르게 답변해줘', '간결하게 정리해줘', '핵심만 뽑아줘'],
        greeting: 'StepFun Step입니다!',
        abilities: { coding: 78, creativity: 74, reasoning: 80, math: 78, multilingual: 80, speed: 92, costEfficiency: 85, contextWindow: 78 },
    },
    {
        id: 'palmyra', name: 'Palmyra X5', nameKo: 'Palmyra X5', icon: '✍️', avatarUrl: '/logos/writer.svg', color: 'purple', category: 'ai', description: '글쓰기 특화 AI, 컨텍스트 1M',
        quote: '글은 AI에게 맡겨라',
        sampleQuestions: ['긴 글 다듬어줘', '보고서 초안 써줘', '문체 개선해줘'],
        greeting: 'Writer Palmyra입니다. 글쓰기를 도와드릴게요!',
        abilities: { coding: 65, creativity: 92, reasoning: 76, math: 62, multilingual: 85, speed: 74, costEfficiency: 68, contextWindow: 95 },
    },
    {
        id: 'hermes', name: 'Hermes 4 405B', nameKo: 'Hermes 4 405B', icon: '🪽', avatarUrl: '/logos/nous.svg', color: 'sky', category: 'ai', description: '오픈소스 커뮤니티 최강 405B',
        quote: '커뮤니티가 만든 괴물',
        sampleQuestions: ['깊은 분석 해줘', '자유롭게 토론하자', '제한 없이 답해줘'],
        greeting: 'Nous Hermes입니다!',
        abilities: { coding: 86, creativity: 84, reasoning: 86, math: 82, multilingual: 82, speed: 68, costEfficiency: 82, contextWindow: 85 },
    },
    {
        id: 'longcat', name: 'LongCat Flash', nameKo: 'LongCat Flash', icon: '🐱', avatarUrl: '/logos/meituan.svg', color: 'amber', category: 'ai', description: '메이퇀 장문맥 AI 모델',
        quote: '긴 글도 고양이처럼 가볍게',
        sampleQuestions: ['긴 문서 요약해줘', '전체 맥락 파악해줘', '장문 분석해줘'],
        greeting: '메이퇀 LongCat입니다!',
        abilities: { coding: 74, creativity: 72, reasoning: 76, math: 72, multilingual: 80, speed: 88, costEfficiency: 85, contextWindow: 96 },
    },
