...
=== 끝 ===` },
  ...
  { id: 'negative-man', name: 'Negative Man', nameKo: '부정맨', icon: '🌧️', color: 'purple', category: 'perspective', description: '"안 될 거야" 최악의 시나리오',
  ...
  { id: 'harsh-tongue', name: 'Harsh Tongue', nameKo: '독설가', icon: '🗡️', color: 'red', category: 'perspective', description: '돌려 말하지 않는 직설 화법',
