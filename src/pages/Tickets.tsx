...
import { trendingMedia, fetchPoster, hasApiFor, canSearch, type MediaSearchResult } from '@/lib/tickets/search';
...
export default function Tickets() {
  ...
  useEffect(() => {
    const targets = entries.filter((e) => !e.posterUrl
      && canSearch(e.kind) && !backfilledRef.current.has(e.id)).slice(0, 10);
