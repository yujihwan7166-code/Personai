      ...
      <main className="flex-1 min-w-0 px-4 sm:px-8 pt-8 sm:pt-12 pb-24 sm:pb-7 max-w-[1320px] w-full mx-auto">
        ...
        <div className="mb-4 pt-1 flex flex-col gap-3 px-0.5 lg:flex-row lg:items-center">
          ...
          <div className="flex items-center gap-3 min-w-0 shrink-0">
            {view !== 'habits' && (
              <div className="flex items-center gap-0.5 bg-background/40 backdrop-blur-md border border-foreground/[0.04] rounded-xl p-0.5 shadow-[inset_0_1px_2px_rgba(var(--foreground)/0.01)] shrink-0">
                <button
                  type="button"
                  onClick={goPrev}
                  aria-label="이전"
                ...
                <button
                  ...
                  className={cn(
                    ...
                    anchorIsToday
                      ...
                      : "bg-card text-foreground border border-foreground/[0.04] hover:bg-accent shadow-[0_2px_5px_rgba(0,0,0,0.03)]"
                  )}
                >
                  오늘
                </button>
