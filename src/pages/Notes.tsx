      ...
      <li key={note.id} className="relative">
        <button
          ...
          className={cn(
            ...
            activeRow ? 'bg-[#2c4f93]/12 font-semibold text-[#2c4f93] dark:bg-[#2c4f93]/28 dark:text-white' : 'text-[#4d5563] hover:bg-white/45 dark:text-foreground/70 dark:hover:bg-white/5',
          )}
        >
