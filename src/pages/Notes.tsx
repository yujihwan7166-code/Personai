      ...
      <li key={note.id} className="relative">
        <button
          ...
          className={cn(
            ...
            activeRow ? 'bg-[#2c4f93]/16 font-semibold text-[#2c4f93] ring-1 ring-inset ring-[#2c4f93]/15 dark:bg-[#2c4f93]/28 dark:text-white dark:ring-white/15' : 'text-[#4d5563] hover:bg-white/45 dark:text-foreground/70 dark:hover:bg-white/5',
          )}
        >
