...
const Notes = () => {
  ...
  return (
    <div className="paper-room flex h-dvh bg-background text-foreground">
      {/* 좌측 목록 */}
      <aside className="flex w-full shrink-0 flex-col border-r border-[#ece5d8] bg-[#faf6ee] dark:border-[hsl(var(--hairline))] dark:bg-[hsl(var(--sidebar-background))] sm:w-[256px]">
