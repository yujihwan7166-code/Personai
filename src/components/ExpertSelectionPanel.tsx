...
export function ExpertSelectionPanel({
  ...
  const POPULAR_IDS = ['gpt', 'claude', 'gemini', 'doctor', 'lawyer', 'sommelier', 'italian', 'fire', 'newlywed', 'conspiracy', 'optimist', 'zhuge-liang', 'christian', 'communist', 'socrates', 'zeus', 'loki'];
