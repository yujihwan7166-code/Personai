    ...
    return (
      ...
      >
        ...
        <div className="relative shrink-0" ref={pickerRef}>
          ...
          >
            <span className="h-1.5 w-1.5 rounded-full shrink-0 self-center" style={{ backgroundColor: engine.dot }} aria-hidden />
            <span className="leading-none self-center">{engine.label}</span>
            <ChevronDown className={cn('h-2.5 w-2.5 shrink-0 self-center transition-transform', pickerOpen && 'rotate-180')} />
          </button>
