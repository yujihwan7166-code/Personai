...
const ALL_ACTIONS: QuickActionItem[] = [
  ...
  },
  {
    ...
    icon: AlertTriangle,
    label: '오늘 막힐 곳 찾기',
    desc: '충돌, 과부하, 우선순위 높은 항목을 먼저 확인합니다',
    prompt: '오늘 일정과 할 일에서 막힐 가능성이 큰 지점을 찾아줘. 일정 충돌, 너무 붙어 있는 구간, 우선순위가 높은데 시간이 없는 항목을 나눠서 알려줘.',
    tint: 'rose',
    primary: true,
    visibleOn: ['day'],
  },
  ...
  },
  {
    ...
    prompt: '다음 주에 부담이 될 일정이나 큰 일이 있는지 보고, 이번 주에 미리 준비해두면 좋은 일을 2-3개 제안해줘.',
    tint: 'violet',
    visibleOn: ['week'],
  },
  {
