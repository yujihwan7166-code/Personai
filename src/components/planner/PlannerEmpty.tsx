  ...
  >
    ...
    {action && (
      <button
        ...
        className="mt-3 px-3 py-1.5 text-[11.5px] font-semibold rounded-md border border-[hsl(var(--hairline))] bg-card text-foreground hover:bg-accent hover:border-foreground/30 transition-colors"
      >
        {action.label}
      </button>
    )}
