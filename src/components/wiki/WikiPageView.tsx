...
import { Archive, Copy, Link2, Pencil, PlusCircle, Trash2, Save, X, Download, Star, Check, History, Home, ChevronDown, FileText, FileType, FileCode, RotateCcw, Sparkles, ListChecks, AlertTriangle } from 'lucide-react';
